...
<center>
    ...
    <h1><font size="40"><a href="Mainpage.html">SAKILA</a></font></h1>
        ...
        <input type="number" name="category_id"  value="<?php echo $category_id;?>"><br><br><br>
        </div>
        <div>
...
if(isset($_POST['search']   ))
{
    ...
    $searchquery="SELECT * FROM `category` WHERE category_id=$data[0] ";
    ...
    if($search_Result)
    {
        ...
        {   
            ...
            while($row=mysqli_fetch_array($search_Result))
            {
                ...
                echo "<tr>";
                echo "<td>";echo "category id"; echo "</td>";
    ...
    {
        $data=getPosts();
        $insertquery="INSERT INTO `category` (`category_id`,`name`,`last_update`) VALUES ('$data[0]','$data[1]','$data[2]')";
        try{
    ...
    {
        $data=getPosts();
        $deletequery="DELETE FROM `category` WHERE `category_id`=$data[0] ";
        try{
    ...
    {
        $data=getPosts();
        $updatequery="UPDATE `category` SET `category_id`='$data[0]',`name`='$data[1]',`last_update`='$data[2]' WHERE `category_id`='$data[0]'";
        try{
